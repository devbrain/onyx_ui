...
TEST_SUITE("Hotkey Scheme") {
    ...
    TEST_CASE("builtin_hotkey_schemes - Windows scheme") {
        ...
        // 10 original bindings + 6 scrolling actions + 8 window management actions + 1 window list + 20 text editing actions + 1 mode toggle + 1 widget activation
        CHECK(scheme.binding_count() == 47);
    }
