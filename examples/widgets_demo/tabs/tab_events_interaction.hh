...
std::unique_ptr<onyxui::panel<Backend>> create_tab_events_interaction() {
    ...
    auto* event_section = content->template emplace_child<onyxui::group_box>();
    ...
    auto* focus_section = content->template emplace_child<onyxui::group_box>();
    ...
    auto* signal_section = content->template emplace_child<onyxui::group_box>();
